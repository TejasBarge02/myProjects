...
public class Womens_Bottom_Wear_3{
	public Womens_Bottom_Wear_3(){
		JFrame b=new JFrame("Shopzyyy/Home/Womens_Bottom_Wear_3");
		...
		JButton Womens_Bottom_Wear_3 = new JButton("Home");
		Womens_Bottom_Wear_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				b.setVisible(false);
				new Home();
			}
		});
		Womens_Bottom_Wear_3.setFont(new Font("Bookman Old Style", Font.PLAIN, 13));
		Womens_Bottom_Wear_3.setBounds(10, 10, 117, 21);
		Womens_Bottom_Wear_3.setForeground(new Color(0, 0, 0));
		Womens_Bottom_Wear_3.setBackground(new Color(255, 255, 102));
		b.getContentPane().add(Womens_Bottom_Wear_3);
		...
		lblNewLabel.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\womens bottom wear\\wb10.jpg"));
		lblNewLabel.setBounds(45, 125, 325, 325);
		b.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\womens bottom wear\\wb8.jpg"));
