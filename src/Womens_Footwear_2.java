...
public class Womens_Footwear_2{
	public Womens_Footwear_2(){
		JFrame b=new JFrame("Shopzyyy/Home/Womens_Footwear_2");
		...
		JButton Womens_Footwear_2 = new JButton("Home");
		Womens_Footwear_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				b.setVisible(false);
				new Home();
			}
		});
		Womens_Footwear_2.setFont(new Font("Bookman Old Style", Font.PLAIN, 13));
		Womens_Footwear_2.setBounds(10, 10, 117, 21);
		Womens_Footwear_2.setForeground(new Color(0, 0, 0));
		Womens_Footwear_2.setBackground(new Color(255, 255, 102));
		b.getContentPane().add(Womens_Footwear_2);
		...
		lblNewLabel.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\womens footwear\\wf5.jpg"));
		lblNewLabel.setBounds(45, 125, 325, 325);
		b.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\womens footwear\\wf6.jpg"));
