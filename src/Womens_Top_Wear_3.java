...
public class Womens_Top_Wear_3{
	public Womens_Top_Wear_3(){
		JFrame b=new JFrame("Shopzyyy/Home/Womens_Top_Wear_3");
		...
		JButton Womens_Top_Wear_3 = new JButton("Home");
		Womens_Top_Wear_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				b.setVisible(false);
				new Home();
			}
		});
		Womens_Top_Wear_3.setFont(new Font("Bookman Old Style", Font.PLAIN, 13));
		Womens_Top_Wear_3.setBounds(10, 10, 117, 21);
		Womens_Top_Wear_3.setForeground(new Color(0, 0, 0));
		Womens_Top_Wear_3.setBackground(new Color(255, 255, 102));
		b.getContentPane().add(Womens_Top_Wear_3);
		...
		lblNewLabel.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\womens top wear\\wt9.jpg"));
		lblNewLabel.setBounds(45, 125, 325, 325);
		b.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\womens top wear\\wt10.jpg"));
		lblNewLabel_1.setBounds(429, 125, 325, 325);
		b.getContentPane().add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("New label");
		lblNewLabel_2.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\womens top wear\\wt11.jpg"));
		lblNewLabel_2.setBounds(805, 125, 325, 325);
		b.getContentPane().add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("New label");
		lblNewLabel_3.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\womens top wear\\wt12.jpg"));
