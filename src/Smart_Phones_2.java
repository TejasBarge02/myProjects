...
public class Smart_Phones_2{
	public Smart_Phones_2(){
		JFrame b=new JFrame("Shopzyyy/Home/Smart_Phones_2");
		...
		JButton Smart_Phones_2 = new JButton("Home");
		Smart_Phones_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				b.setVisible(false);
				new Home();
			}
		});
		Smart_Phones_2.setFont(new Font("Bookman Old Style", Font.PLAIN, 13));
		Smart_Phones_2.setBounds(10, 10, 117, 21);
		Smart_Phones_2.setForeground(new Color(0, 0, 0));
		Smart_Phones_2.setBackground(new Color(255, 255, 102));
		b.getContentPane().add(Smart_Phones_2);
		...
		lblNewLabel.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\smart phones\\sp5.jpg"));
		lblNewLabel.setBounds(45, 125, 325, 325);
		b.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\smart phones\\sp6.jpg"));
