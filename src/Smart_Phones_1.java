...
public class Smart_Phones_1{
	public Smart_Phones_1(){
		JFrame b=new JFrame("Shopzyyy/Home/Smart_Phones_1");
		...
		JButton Smart_Phones_1 = new JButton("Home");
		Smart_Phones_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				b.setVisible(false);
				new Home();
			}
		});
		Smart_Phones_1.setFont(new Font("Bookman Old Style", Font.PLAIN, 13));
		Smart_Phones_1.setBounds(10, 10, 117, 21);
		Smart_Phones_1.setForeground(new Color(0, 0, 0));
		Smart_Phones_1.setBackground(new Color(255, 255, 102));
		b.getContentPane().add(Smart_Phones_1);
		...
		lblNewLabel.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\smart phones\\sp1.jpg"));
		lblNewLabel.setBounds(45, 125, 325, 325);
		b.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\smart phones\\sp2.jpg"));
		lblNewLabel_1.setBounds(421, 125, 325, 325);
		b.getContentPane().add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("New label");
		lblNewLabel_2.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\smart phones\\sp3.jpg"));
		lblNewLabel_2.setBounds(805, 125, 325, 325);
		b.getContentPane().add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("New label");
		lblNewLabel_3.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\smart phones\\sp4.jpg"));
