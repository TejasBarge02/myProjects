...
public class Home_Appliances_1{
	public Home_Appliances_1(){
		JFrame b=new JFrame("Shopzyyy/Home/Home_Appliances_1");
		...
		JButton Home_Appliances_1 = new JButton("Home");
		Home_Appliances_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				b.setVisible(false);
				new Home();
			}
		});
		Home_Appliances_1.setFont(new Font("Bookman Old Style", Font.PLAIN, 13));
		Home_Appliances_1.setBounds(10, 10, 117, 21);
		Home_Appliances_1.setForeground(new Color(0, 0, 0));
		Home_Appliances_1.setBackground(new Color(255, 255, 102));
		b.getContentPane().add(Home_Appliances_1);
		...
		lblNewLabel.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\home appliances\\ha1.jpg"));
		lblNewLabel.setBounds(45, 125, 325, 325);
		b.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\home appliances\\ha2.jpg"));
		lblNewLabel_1.setBounds(421, 125, 325, 325);
		b.getContentPane().add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("New label");
		lblNewLabel_2.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\home appliances\\ha3.jpg"));
		lblNewLabel_2.setBounds(805, 125, 325, 325);
		b.getContentPane().add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("New label");
		lblNewLabel_3.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\home appliances\\ha4.jpg"));
