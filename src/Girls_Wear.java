...
public class Girls_Wear{
	public Girls_Wear(){
		JFrame b=new JFrame("Shopzyyy/Home/Girls_Wear");
		...
		JButton Girls_Wear = new JButton("Home");
		Girls_Wear.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				b.setVisible(false);
				new Home();
			}
		});
		Girls_Wear.setFont(new Font("Bookman Old Style", Font.PLAIN, 13));
		Girls_Wear.setBounds(10, 10, 117, 21);
		Girls_Wear.setForeground(new Color(0, 0, 0));
		Girls_Wear.setBackground(new Color(255, 255, 102));
		b.getContentPane().add(Girls_Wear);
		...
		lblNewLabel.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\girls wear\\gw1.jpg"));
		lblNewLabel.setBounds(45, 125, 325, 325);
		b.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\girls wear\\gw3.jpg"));
