...
public class Mens_Top_Wear_3{
	public Mens_Top_Wear_3(){
		JFrame b=new JFrame("Shopzyyy/Home/Mens_Top_Wear_3");
		...
		JButton Mens_Top_Wear_3 = new JButton("Home");
		Mens_Top_Wear_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				b.setVisible(false);
				new Home();
			}
		});
		Mens_Top_Wear_3.setFont(new Font("Bookman Old Style", Font.PLAIN, 13));
		Mens_Top_Wear_3.setBounds(10, 10, 117, 21);
		Mens_Top_Wear_3.setForeground(new Color(0, 0, 0));
		Mens_Top_Wear_3.setBackground(new Color(255, 255, 102));
		b.getContentPane().add(Mens_Top_Wear_3);
		...
		lblNewLabel.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\Mens top wear\\mt11.jpg"));
		lblNewLabel.setBounds(45, 125, 325, 325);
		b.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\Mens top wear\\mt12.jpg"));
		lblNewLabel_1.setBounds(421, 125, 325, 325);
		b.getContentPane().add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("New label");
		lblNewLabel_2.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\Mens top wear\\mt15.jpg"));
		lblNewLabel_2.setBounds(805, 125, 325, 325);
		b.getContentPane().add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("New label");
		lblNewLabel_3.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\Mens top wear\\mt16.jpg"));
