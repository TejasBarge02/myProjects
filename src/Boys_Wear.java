...
public class Boys_Wear{
	public Boys_Wear(){
		JFrame b=new JFrame("Shopzyyy/Home/Boys_Wear");
		...
		JButton Boys_Wear = new JButton("Home");
		Boys_Wear.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				b.setVisible(false);
				new Home();
			}
		});
		Boys_Wear.setFont(new Font("Bookman Old Style", Font.PLAIN, 13));
		Boys_Wear.setBounds(10, 10, 117, 21);
		Boys_Wear.setForeground(new Color(0, 0, 0));
		Boys_Wear.setBackground(new Color(255, 255, 102));
		b.getContentPane().add(Boys_Wear);
		...
		lblNewLabel.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\boys wear\\bw1.jpg"));
		lblNewLabel.setBounds(45, 125, 325, 325);
		b.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\boys wear\\bw2.jpg"));
		lblNewLabel_1.setBounds(421, 125, 325, 325);
		b.getContentPane().add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("New label");
		lblNewLabel_2.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\boys wear\\bw3.jpg"));
