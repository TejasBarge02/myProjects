...
public class Mens_Footwear_1{
	public Mens_Footwear_1(){
		JFrame b=new JFrame("Shopzyyy/Home/Mens_Footware_1");
		...
		JButton Mens_Footware_1 = new JButton("Home");
		Mens_Footware_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				b.setVisible(false);
				new Home();
			}
		});
		Mens_Footware_1.setFont(new Font("Bookman Old Style", Font.PLAIN, 13));
		Mens_Footware_1.setBounds(10, 10, 117, 21);
		Mens_Footware_1.setForeground(new Color(0, 0, 0));
		Mens_Footware_1.setBackground(new Color(255, 255, 102));
		b.getContentPane().add(Mens_Footware_1);
		...
		lblNewLabel.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\mens footwear\\mf1.jpg"));
		lblNewLabel.setBounds(45, 125, 325, 325);
		b.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\mens footwear\\mf2.jpg"));
		lblNewLabel_1.setBounds(421, 125, 325, 325);
		b.getContentPane().add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("New label");
		lblNewLabel_2.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\mens footwear\\mf4.jpg"));
		lblNewLabel_2.setBounds(805, 125, 325, 325);
		b.getContentPane().add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("New label");
		lblNewLabel_3.setIcon(new ImageIcon("D:\\VIT\\Sem3\\Notes\\SBL-Java\\Programs\\Mini_Project\\Resources\\mens footwear\\mf5.jpg"));
